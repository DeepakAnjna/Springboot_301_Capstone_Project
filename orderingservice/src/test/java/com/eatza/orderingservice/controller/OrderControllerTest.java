...
import com.eatza.order.kafka.sender.MessageData;
import com.eatza.order.kafka.sender.MsgPublisher;
import com.eatza.order.kafka.sender.SenderConfig;
...
@ContextConfiguration(classes = { OrderController.class, MsgPublisher.class,SenderConfig.class,CustomGlobalExceptionHandler.class })
